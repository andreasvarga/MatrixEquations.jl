...
[MatrixEquations](https://github.com/andreasvarga/MatrixEquations.jl) is a Julia package 
to solve some control system related matrix equations.
...
## Future plans
The collection of tools will be extended by adding new functionality, such as the computation of condition number estimators for Lyapunov and Sylvester equations, etc.
...
- The first registered version for the public
